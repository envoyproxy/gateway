...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EnvoyProxyDeploymentSpec) DeepCopyInto(out *EnvoyProxyDeploymentSpec) {
	*out = *in
	in.KubernetesDeploymentSpec.DeepCopyInto(&out.KubernetesDeploymentSpec)
	if in.ShutdownManagerContainer != nil {
		in, out := &in.ShutdownManagerContainer, &out.ShutdownManagerContainer
		*out = new(KubernetesContainerSpec)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EnvoyProxyDeploymentSpec.
func (in *EnvoyProxyDeploymentSpec) DeepCopy() *EnvoyProxyDeploymentSpec {
	if in == nil {
		return nil
	}
	out := new(EnvoyProxyDeploymentSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ShutdownConfig) DeepCopyInto(out *ShutdownConfig) {
	*out = *in
	...
	if in.ExitAtConnections != nil {
		in, out := &in.ExitAtConnections, &out.ExitAtConnections
		*out = new(int32)
		**out = **in
	}
}
