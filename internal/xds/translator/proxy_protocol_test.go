...
func TestPatchProxyProtocolFilter(t *testing.T) {
	...
	testCases := []testCase{
		...
		{
			name:                "proxyProtocolSettings with AllowRequestsWithoutProxyProtocol=false only",
			listener:            &listenerv3.Listener{},
			enableProxyProtocol: false,
			proxyProtocolSettings: &ir.ProxyProtocolSettings{
		...
		{
			name:                "proxyProtocolSettings with AllowRequestsWithoutProxyProtocol=true only",
			listener:            &listenerv3.Listener{},
			enableProxyProtocol: false,
			proxyProtocolSettings: &ir.ProxyProtocolSettings{
		...
		{
			name:                "both APIs: enableProxyProtocol=true, AllowRequestsWithoutProxyProtocol=false",
			listener:            &listenerv3.Listener{},
			enableProxyProtocol: true,
			proxyProtocolSettings: &ir.ProxyProtocolSettings{
				AllowRequestsWithoutProxyProtocol: false,
		...
		{
			name:                "both APIs: enableProxyProtocol=true, AllowRequestsWithoutProxyProtocol=true",
			listener:            &listenerv3.Listener{},
			enableProxyProtocol: true,
			proxyProtocolSettings: &ir.ProxyProtocolSettings{
				AllowRequestsWithoutProxyProtocol: true,
