...
- 部署一个后端服务和一个网关
- 使用 Kubernetes Gateway API 资源[网关](https://gateway-api.sigs.k8s.io/api-types/gateway/)和 [HTTP 路由](https://gateway-api.sigs.k8s.io/api-types/httproute/)配置网关。将通过 HTTP 传入的请求定向到后端服务。
