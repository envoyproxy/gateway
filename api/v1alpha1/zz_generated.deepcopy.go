...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExtProcMatch) DeepCopyInto(out *ExtProcMatch) {
	*out = *in
	if in.Headers != nil {
		in, out := &in.Headers, &out.Headers
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExtProcMatch.
func (in *ExtProcMatch) DeepCopy() *ExtProcMatch {
	if in == nil {
		return nil
	}
	out := new(ExtProcMatch)
	in.DeepCopyInto(out)
	return out
}
