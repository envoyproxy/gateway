...
go.testdata.complete: ## Override test ouputdata
	...
	# 30s is not enough for the test to complete
	go test -timeout 60s github.com/envoyproxy/gateway/internal/infrastructure/kubernetes/proxy --override-testdata=true
