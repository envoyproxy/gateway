...
func (in *EnvoyProxyKubernetesProvider) DeepCopyInto(out *EnvoyProxyKubernetesProvider) {
	*out = *in
	...
	if in.EnvoyConfigMap != nil {
		in, out := &in.EnvoyConfigMap, &out.EnvoyConfigMap
		*out = new(KubernetesConfigMapSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubernetesConfigMapSpec) DeepCopyInto(out *KubernetesConfigMapSpec) {
	*out = *in
	if in.Name != nil {
		in, out := &in.Name, &out.Name
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubernetesConfigMapSpec.
func (in *KubernetesConfigMapSpec) DeepCopy() *KubernetesConfigMapSpec {
	if in == nil {
		return nil
	}
	out := new(KubernetesConfigMapSpec)
