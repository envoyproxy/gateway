...
type TraceSearchMetadata struct {
	...
	StartTimeUnixNano string `protobuf:"varint,4,opt,name=startTimeUnixNano,proto3" json:"startTimeUnixNano,omitempty"` // store uint64 in string
...
type SearchMetrics struct {
	...
	InspectedBytes  string `protobuf:"varint,2,opt,name=inspectedBytes,proto3" json:"inspectedBytes,omitempty"`
	InspectedBlocks uint32 `protobuf:"varint,3,opt,name=inspectedBlocks,proto3" json:"inspectedBlocks,omitempty"` // store uint64 in string
	...
	TotalBlockBytes string `protobuf:"varint,6,opt,name=totalBlockBytes,proto3" json:"totalBlockBytes,omitempty"` // store uint64 in string
}
