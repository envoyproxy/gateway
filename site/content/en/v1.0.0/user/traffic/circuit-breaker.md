...
[Envoy circuit breakers](https://www.envoyproxy.io/docs/envoy/latest/intro/arch_overview/upstream/circuit_breaking) can be used to fail quickly and apply back-pressure in response to upstream service degradation.
