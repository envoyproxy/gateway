...
type BackendTLSConfig struct {
	...
	// If namespace is omitted, the referring resource's namespace is used.
	// Cross-namespace references are not supported, even with a ReferenceGrant.
	// The generic ReferenceGrant guidance in SecretObjectReference does not apply to this field.
	// +optional
