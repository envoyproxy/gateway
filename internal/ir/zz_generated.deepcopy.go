...
func (in *HeaderSettings) DeepCopyInto(out *HeaderSettings) {
	*out = *in
	...
	if in.EarlyRequestHeaderMutations != nil {
		in, out := &in.EarlyRequestHeaderMutations, &out.EarlyRequestHeaderMutations
		*out = make([]HeaderMutation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.LateResponseHeaderMutations != nil {
		in, out := &in.LateResponseHeaderMutations, &out.LateResponseHeaderMutations
		*out = make([]HeaderMutation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HeaderWrite) DeepCopyInto(out *HeaderWrite) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HeaderWrite.
func (in *HeaderWrite) DeepCopy() *HeaderWrite {
	if in == nil {
		return nil
	}
	out := new(HeaderWrite)
...
func (in *Xds) DeepCopyInto(out *Xds) {
	*out = *in
	...
	if in.ExtensionResources != nil {
		in, out := &in.ExtensionResources, &out.ExtensionResources
		*out = make([]*UnstructuredRef, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
