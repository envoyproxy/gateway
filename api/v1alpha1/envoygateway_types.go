...
type ExtensionManager struct {
	...
	// custom backendRef resources. These resources can be referenced in HTTPRoute and
	// GRPCRoute backendRefs to enable support for custom backend types (e.g., S3, Lambda, etc.)
