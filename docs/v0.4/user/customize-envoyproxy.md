...
spec:
  provider:
    ...
    kubernetes:
      envoyDeployment:
        container:
          image: envoyproxy/envoy:v1.25-v0.4
EOF
```
...
You can use [egctl translate](https://gateway.envoyproxy.io/v0.4/user/egctl.html#validating-gateway-api-configuration)
...
[EnvoyProxy]: https://gateway.envoyproxy.io/v0.4/api/config_types.html#envoyproxy 
