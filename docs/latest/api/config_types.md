...
| `concurrency` _integer_ | Concurrency defines the number of worker threads to run. If unset, the default back to Envoy default value which the number of hardware threads on the machine. |
