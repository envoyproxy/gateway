...
func (in *DestinationSetting) DeepCopyInto(out *DestinationSetting) {
	*out = *in
	if in.StaticResolverConfig != nil {
		in, out := &in.StaticResolverConfig, &out.StaticResolverConfig
		*out = new(StaticResolverConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.Weight != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StaticResolverConfig) DeepCopyInto(out *StaticResolverConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StaticResolverConfig.
func (in *StaticResolverConfig) DeepCopy() *StaticResolverConfig {
	if in == nil {
		return nil
	}
	out := new(StaticResolverConfig)
