...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *XDSHooks) DeepCopyInto(out *XDSHooks) {
	*out = *in
	if in.Pre != nil {
		in, out := &in.Pre, &out.Pre
		*out = make([]XDSHook, len(*in))
		copy(*out, *in)
	}
	if in.Post != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new XDSHooks.
func (in *XDSHooks) DeepCopy() *XDSHooks {
	if in == nil {
		return nil
	}
	out := new(XDSHooks)
