...
* The global rate limit feature is based on [Envoy Ratelimit](https://github.com/envoyproxy/ratelimit) which requires a Redis instance as its caching layer. Lets install a Redis deployment in the `redis-system` namespce.
