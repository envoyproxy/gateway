...
func (in *BackendTrafficPolicySpec) DeepCopyInto(out *BackendTrafficPolicySpec) {
	*out = *in
	...
	if in.OriginalSrc != nil {
		in, out := &in.OriginalSrc, &out.OriginalSrc
		*out = new(OriginalSrc)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OriginalSrc) DeepCopyInto(out *OriginalSrc) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OriginalSrc.
func (in *OriginalSrc) DeepCopy() *OriginalSrc {
	if in == nil {
		return nil
	}
	out := new(OriginalSrc)
