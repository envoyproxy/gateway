...
[req_filter]: https://gateway-api.sigs.k8s.io/reference/1.3/spec/#httprequestredirectfilter
[sectionName]: https://gateway-api.sigs.k8s.io/reference/1.3/spec/#commonroutespec
