...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CACertificateEntry) DeepCopyInto(out *CACertificateEntry) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CACertificateEntry.
func (in *CACertificateEntry) DeepCopy() *CACertificateEntry {
	if in == nil {
		return nil
	}
	out := new(CACertificateEntry)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Xds) DeepCopyInto(out *Xds) {
	*out = *in
	...
	if in.CACertificates != nil {
		...
		*out = make([]*CACertificateEntry, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(CACertificateEntry)
