...
func TestEnvoyProxyProvider(t *testing.T) {
	...
	cases := []struct {
		...
		{
			desc: "AccessLogBufferSettings-with-zero-flushInterval",
			mutate: func(envoy *egv1a1.EnvoyProxy) {
				envoy.Spec = egv1a1.EnvoyProxySpec{
					Telemetry: &egv1a1.ProxyTelemetry{
						AccessLog: &egv1a1.ProxyAccessLog{
									...
									Sinks: []egv1a1.ProxyAccessLogSink{
										{
											...
											OpenTelemetry: &egv1a1.OpenTelemetryEnvoyProxyAccessLog{
												...
												Buffer: &egv1a1.AccessLogBufferSettings{
		...
		{
			desc: "AccessLogBufferSettings-with-malformed-sizeBytes",
			mutate: func(envoy *egv1a1.EnvoyProxy) {
				envoy.Spec = egv1a1.EnvoyProxySpec{
					Telemetry: &egv1a1.ProxyTelemetry{
						AccessLog: &egv1a1.ProxyAccessLog{
		...
		},
		{
			...
			desc: "valid-AccessLogBufferSettings",
			mutate: func(envoy *egv1a1.EnvoyProxy) {
				envoy.Spec = egv1a1.EnvoyProxySpec{
					Telemetry: &egv1a1.ProxyTelemetry{
						AccessLog: &egv1a1.ProxyAccessLog{
