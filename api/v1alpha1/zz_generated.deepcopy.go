...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ForwardProtoConfig) DeepCopyInto(out *ForwardProtoConfig) {
	*out = *in
	if in.HTTPSDestinationPorts != nil {
		in, out := &in.HTTPSDestinationPorts, &out.HTTPSDestinationPorts
		*out = make([]int32, len(*in))
		copy(*out, *in)
	}
	if in.HTTPDestinationPorts != nil {
		in, out := &in.HTTPDestinationPorts, &out.HTTPDestinationPorts
		*out = make([]int32, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ForwardProtoConfig.
func (in *ForwardProtoConfig) DeepCopy() *ForwardProtoConfig {
	if in == nil {
		return nil
	}
