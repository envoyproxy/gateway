			...
			policy: &egv1a1.ClusterSettings{
				Timeout: &egv1a1.Timeout{
					HTTP: &egv1a1.HTTPTimeout{
						...
						StreamTimeout:         ptr.To(gwapiv1.Duration("60s")),
						GrpcTimeoutHeaderMax:  ptr.To(gwapiv1.Duration("25s")),
					},
				},
			},
			want: &ir.Timeout{
				HTTP: &ir.HTTPTimeout{
					...
					StreamTimeout:         ptr.To(metav1.Duration{Duration: 60 * time.Second}),
					GrpcTimeoutHeaderMax:  ptr.To(metav1.Duration{Duration: 25 * time.Second}),
				},
			},
		},
		{
