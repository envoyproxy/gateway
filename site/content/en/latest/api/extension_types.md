...
| `earlyRequestHeaderModifier` | _[HTTPHeaderFilter](#httpheaderfilter)_ |  false  | EarlyRequestHeaderModifier defines settings for early request header modification, before envoy performs<br />routing, tracing and built-in header manipulation. |
