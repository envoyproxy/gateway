...
func (in *CustomMetricScale) DeepCopyInto(out *CustomMetricScale) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomMetricScale.
func (in *CustomMetricScale) DeepCopy() *CustomMetricScale {
	if in == nil {
		return nil
	}
	out := new(CustomMetricScale)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProxyMetrics) DeepCopyInto(out *ProxyMetrics) {
	*out = *in
	...
	in.CustomMetricScales.DeepCopyInto(&out.CustomMetricScales)
}
...
func (in *ProxyStatsMatcher) DeepCopyInto(out *ProxyStatsMatcher) {
	*out = *in
	if in.InclusionMatches != nil {
		in, out := &in.InclusionMatches, &out.InclusionMatches
