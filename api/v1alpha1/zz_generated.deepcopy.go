...
func (in *ClientTrafficPolicySpec) DeepCopyInto(out *ClientTrafficPolicySpec) {
	*out = *in
	...
	if in.HTTPConnectionManager != nil {
		in, out := &in.HTTPConnectionManager, &out.HTTPConnectionManager
		*out = new(HTTPConnectionManagerSettings)
		(*in).DeepCopyInto(*out)
	}
	if in.HTTP3 != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPConnectionManagerSettings) DeepCopyInto(out *HTTPConnectionManagerSettings) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPConnectionManagerSettings.
func (in *HTTPConnectionManagerSettings) DeepCopy() *HTTPConnectionManagerSettings {
	if in == nil {
		return nil
	}
	out := new(HTTPConnectionManagerSettings)
