			...
			expectedResponse := http.ExpectedResponse{
				...
				Response: http.Response{
					...
					Headers: map[string]string{
						...
						// header added by ext-processor to response based on the
						// envoy.filters.http.rbac.enforced_engine_result dynamic metadata
						"x-request-rbac-result-metadata": "allowed",
					},
				},
				Namespace: ns,
			}
