...
func TestEnvoyProxyProvider(t *testing.T) {
	...
	cases := []struct {
		...
		{
			desc: "cannot set clientSamplingRate and clientSamplingFraction at the same time",
			mutate: func(envoy *egv1a1.EnvoyProxy) {
				envoy.Spec = egv1a1.EnvoyProxySpec{
					Telemetry: &egv1a1.ProxyTelemetry{
						Tracing: &egv1a1.ProxyTracing{
							ClientSamplingRate: new(uint32(1)),
							Tracing: egv1a1.Tracing{
								ClientSamplingFraction: &gwapiv1.Fraction{Numerator: 1, Denominator: new(int32(1000))},
							},
							Provider: egv1a1.TracingProvider{
								BackendCluster: egv1a1.BackendCluster{
									BackendRefs: []egv1a1.BackendRef{
			...
			wantErrors: []string{
				"only one of ClientSamplingRate or ClientSamplingFraction can be specified",
			},
		},
		{
			desc: "cannot set overallSamplingRate and overallSamplingFraction at the same time",
			mutate: func(envoy *egv1a1.EnvoyProxy) {
				envoy.Spec = egv1a1.EnvoyProxySpec{
					Telemetry: &egv1a1.ProxyTelemetry{
						Tracing: &egv1a1.ProxyTracing{
							OverallSamplingRate: new(uint32(1)),
							Tracing: egv1a1.Tracing{
								OverallSamplingFraction: &gwapiv1.Fraction{Numerator: 1, Denominator: new(int32(1000))},
							},
							Provider: egv1a1.TracingProvider{
								BackendCluster: egv1a1.BackendCluster{
									BackendRefs: []egv1a1.BackendRef{
			...
			wantErrors: []string{
				"only one of OverallSamplingRate or OverallSamplingFraction can be specified",
			},
		},
		{
