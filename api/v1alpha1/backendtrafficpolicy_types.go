...
// +kubebuilder:validation:XValidation:rule="has(self.targetRef) ? self.targetRef.group in ['gateway.networking.k8s.io', '', 'multicluster.x-k8s.io', 'gateway.envoyproxy.io'] : true ", message="this policy can only have a targetRef.group of gateway.networking.k8s.io, multicluster.x-k8s.io, gateway.envoyproxy.io, or an empty string"
// +kubebuilder:validation:XValidation:rule="has(self.targetRef) ? self.targetRef.kind in ['Gateway', 'ListenerSet', 'HTTPRoute', 'GRPCRoute', 'UDPRoute', 'TCPRoute', 'TLSRoute', 'Service', 'ServiceImport', 'Backend'] : true", message="this policy can only have a targetRef.kind of Gateway/ListenerSet/HTTPRoute/GRPCRoute/TCPRoute/UDPRoute/TLSRoute/Service/ServiceImport/Backend"
// +kubebuilder:validation:XValidation:rule="has(self.targetRefs) ? self.targetRefs.all(ref, ref.group in ['gateway.networking.k8s.io', '', 'multicluster.x-k8s.io', 'gateway.envoyproxy.io']) : true ", message="this policy can only have a targetRefs[*].group of gateway.networking.k8s.io, multicluster.x-k8s.io, gateway.envoyproxy.io, or an empty string"
// +kubebuilder:validation:XValidation:rule="has(self.targetRefs) ? self.targetRefs.all(ref, ref.kind in ['Gateway', 'ListenerSet', 'HTTPRoute', 'GRPCRoute', 'UDPRoute', 'TCPRoute', 'TLSRoute', 'Service', 'ServiceImport', 'Backend']) : true ", message="this policy can only have a targetRefs[*].kind of Gateway/ListenerSet/HTTPRoute/GRPCRoute/TCPRoute/UDPRoute/TLSRoute/Service/ServiceImport/Backend"
