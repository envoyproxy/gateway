...
manifests: $(tools/controller-gen) generate-gwapi-manifests ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	@$(LOG_TARGET)
	$(tools/controller-gen) rbac:roleName=envoy-gateway-role \
	crd:allowDangerousTypes=true \
	webhook paths="./..." \
	output:crd:artifacts:config=charts/gateway-helm/crds/generated \
	output:rbac:artifacts:config=charts/gateway-helm/templates/generated/rbac \
	output:webhook:artifacts:config=charts/gateway-helm/templates/generated/webhook
