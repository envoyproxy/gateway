...
func (in *OIDC) DeepCopyInto(out *OIDC) {
	*out = *in
	...
	if in.DenyRedirectMatcher != nil {
		in, out := &in.DenyRedirectMatcher, &out.DenyRedirectMatcher
		*out = make([]OIDCDenyRedirectMatcher, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OIDCDenyRedirectMatcher) DeepCopyInto(out *OIDCDenyRedirectMatcher) {
	*out = *in
	in.StringMatch.DeepCopyInto(&out.StringMatch)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OIDCDenyRedirectMatcher.
func (in *OIDCDenyRedirectMatcher) DeepCopy() *OIDCDenyRedirectMatcher {
	if in == nil {
		return nil
	}
	out := new(OIDCDenyRedirectMatcher)
	in.DeepCopyInto(out)
	return out
}
