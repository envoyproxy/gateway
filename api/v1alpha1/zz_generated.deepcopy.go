...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClientCertPrincipal) DeepCopyInto(out *ClientCertPrincipal) {
	*out = *in
	if in.Subject != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClientCertPrincipal.
func (in *ClientCertPrincipal) DeepCopy() *ClientCertPrincipal {
	if in == nil {
		return nil
	}
	out := new(ClientCertPrincipal)
	in.DeepCopyInto(out)
	return out
}
