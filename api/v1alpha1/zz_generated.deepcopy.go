...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JWTFromHeader) DeepCopyInto(out *JWTFromHeader) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JWTFromHeader.
func (in *JWTFromHeader) DeepCopy() *JWTFromHeader {
	if in == nil {
		return nil
	}
	out := new(JWTFromHeader)
	in.DeepCopyInto(out)
	return out
}
