...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RemoteGeoIPDBSource) DeepCopyInto(out *RemoteGeoIPDBSource) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RemoteGeoIPDBSource.
func (in *RemoteGeoIPDBSource) DeepCopy() *RemoteGeoIPDBSource {
	if in == nil {
		return nil
	}
	out := new(RemoteGeoIPDBSource)
