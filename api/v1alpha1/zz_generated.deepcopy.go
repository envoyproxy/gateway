...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HealthCheckEventLogSink) DeepCopyInto(out *HealthCheckEventLogSink) {
	*out = *in
	if in.File != nil {
		in, out := &in.File, &out.File
		*out = new(HealthCheckLoggingFileSink)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HealthCheckEventLogSink.
func (in *HealthCheckEventLogSink) DeepCopy() *HealthCheckEventLogSink {
	if in == nil {
		return nil
	}
	out := new(HealthCheckEventLogSink)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HealthCheckLoggingFileSink) DeepCopyInto(out *HealthCheckLoggingFileSink) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HealthCheckLoggingFileSink.
func (in *HealthCheckLoggingFileSink) DeepCopy() *HealthCheckLoggingFileSink {
	if in == nil {
		return nil
	}
	out := new(HealthCheckLoggingFileSink)
...
func (in *ProxyHealthCheckLog) DeepCopyInto(out *ProxyHealthCheckLog) {
	*out = *in
	if in.Sinks != nil {
		in, out := &in.Sinks, &out.Sinks
		*out = make([]HealthCheckEventLogSink, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.AlwaysLogHealthCheckSuccess != nil {
		in, out := &in.AlwaysLogHealthCheckSuccess, &out.AlwaysLogHealthCheckSuccess
		*out = new(bool)
		**out = **in
	}
}
