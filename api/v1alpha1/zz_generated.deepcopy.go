...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BufferRequests) DeepCopyInto(out *BufferRequests) {
	*out = *in
	out.MaxBufferSize = in.MaxBufferSize.DeepCopy()
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BufferRequests.
func (in *BufferRequests) DeepCopy() *BufferRequests {
	if in == nil {
		return nil
	}
	out := new(BufferRequests)
