...
var DirectResponseTest = suite.ConformanceTest{
	...
	Test: func(t *testing.T, suite *suite.ConformanceTestSuite) {
		t.Run("direct response", func(t *testing.T) {
			...
			verifyCustomResponse(t, gwAddr, "/status/inline", "text/plain", "Oops! Your request is not found.")
			verifyCustomResponse(t, gwAddr, "/status/value-ref", "application/json", `{"error": "Internal Server Error"}`)
		})
	},
}
