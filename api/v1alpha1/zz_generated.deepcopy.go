...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PreferLocalZoneConfig) DeepCopyInto(out *PreferLocalZoneConfig) {
	*out = *in
	if in.ForceLocal != nil {
		in, out := &in.ForceLocal, &out.ForceLocal
		*out = new(bool)
		**out = **in
	}
	if in.ForceLocalMinZoneSize != nil {
		in, out := &in.ForceLocalMinZoneSize, &out.ForceLocalMinZoneSize
		*out = new(uint64)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PreferLocalZoneConfig.
func (in *PreferLocalZoneConfig) DeepCopy() *PreferLocalZoneConfig {
	if in == nil {
		return nil
	}
	out := new(PreferLocalZoneConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RequestDistribution) DeepCopyInto(out *RequestDistribution) {
	*out = *in
	if in.PreferLocalZoneConfig != nil {
		in, out := &in.PreferLocalZoneConfig, &out.PreferLocalZoneConfig
		*out = new(PreferLocalZoneConfig)
		(*in).DeepCopyInto(*out)
	}
