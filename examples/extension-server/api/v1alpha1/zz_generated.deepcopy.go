...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RouteContextExample) DeepCopyInto(out *RouteContextExample) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RouteContextExample.
func (in *RouteContextExample) DeepCopy() *RouteContextExample {
	if in == nil {
		return nil
	}
	out := new(RouteContextExample)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RouteContextExample) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RouteContextExampleList) DeepCopyInto(out *RouteContextExampleList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]RouteContextExample, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RouteContextExampleList.
func (in *RouteContextExampleList) DeepCopy() *RouteContextExampleList {
	if in == nil {
		return nil
	}
	out := new(RouteContextExampleList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RouteContextExampleList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RouteContextExampleSpec) DeepCopyInto(out *RouteContextExampleSpec) {
	*out = *in
	if in.TargetRefs != nil {
		in, out := &in.TargetRefs, &out.TargetRefs
		*out = make([]v1.LocalPolicyTargetReferenceWithSectionName, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RouteContextExampleSpec.
func (in *RouteContextExampleSpec) DeepCopy() *RouteContextExampleSpec {
	if in == nil {
		return nil
	}
	out := new(RouteContextExampleSpec)
	in.DeepCopyInto(out)
	return out
}
