...
func (in *BackendTrafficPolicySpec) DeepCopyInto(out *BackendTrafficPolicySpec) {
	*out = *in
	...
	if in.Decompression != nil {
		...
		*out = make([]*Decompression, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(Decompression)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CompressorLibrary) DeepCopyInto(out *CompressorLibrary) {
	*out = *in
	if in.GzipCompressor != nil {
		in, out := &in.GzipCompressor, &out.GzipCompressor
		*out = new(GzipCompressor)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CompressorLibrary.
func (in *CompressorLibrary) DeepCopy() *CompressorLibrary {
	if in == nil {
		return nil
	}
	out := new(CompressorLibrary)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Decompression) DeepCopyInto(out *Decompression) {
	*out = *in
	if in.DecompressiorLibrary != nil {
		in, out := &in.DecompressiorLibrary, &out.DecompressiorLibrary
		*out = new(DecompressorLibrary)
		(*in).DeepCopyInto(*out)
	}
	if in.GzipDecompressor != nil {
		in, out := &in.GzipDecompressor, &out.GzipDecompressor
		*out = new(GzipDecompressor)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Decompression.
func (in *Decompression) DeepCopy() *Decompression {
	if in == nil {
		return nil
	}
	out := new(Decompression)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DecompressorLibrary) DeepCopyInto(out *DecompressorLibrary) {
	*out = *in
	if in.GzipDecompressor != nil {
		in, out := &in.GzipDecompressor, &out.GzipDecompressor
		*out = new(GzipDecompressor)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DecompressorLibrary.
func (in *DecompressorLibrary) DeepCopy() *DecompressorLibrary {
	if in == nil {
		return nil
	}
	out := new(DecompressorLibrary)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GzipDecompressor) DeepCopyInto(out *GzipDecompressor) {
	*out = *in
	if in.WindowBits != nil {
		in, out := &in.WindowBits, &out.WindowBits
		*out = new(uint32)
	...
	if in.MaxInflateRatio != nil {
		in, out := &in.MaxInflateRatio, &out.MaxInflateRatio
		*out = new(uint32)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GzipDecompressor.
func (in *GzipDecompressor) DeepCopy() *GzipDecompressor {
	if in == nil {
		return nil
	}
	out := new(GzipDecompressor)
