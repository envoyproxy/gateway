...
func (in *GlobalResources) DeepCopyInto(out *GlobalResources) {
	*out = *in
	...
	if in.RateLimitServiceCluster != nil {
		...
		*out = new(RateLimitServiceCluster)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RateLimitServiceCluster) DeepCopyInto(out *RateLimitServiceCluster) {
	*out = *in
	in.RouteDestination.DeepCopyInto(&out.RouteDestination)
	if in.Traffic != nil {
		in, out := &in.Traffic, &out.Traffic
		*out = new(ClusterTrafficFeatures)
		(*in).DeepCopyInto(*out)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RateLimitServiceCluster.
func (in *RateLimitServiceCluster) DeepCopy() *RateLimitServiceCluster {
	if in == nil {
		return nil
	}
	out := new(RateLimitServiceCluster)
