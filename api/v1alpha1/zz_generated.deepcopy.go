...
func (in *MetadataKey) DeepCopyInto(out *MetadataKey) {
	*out = *in
	if in.Path != nil {
		in, out := &in.Path, &out.Path
		*out = make([]MetadataKeyPath, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetadataKeyPath) DeepCopyInto(out *MetadataKeyPath) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetadataKeyPath.
func (in *MetadataKeyPath) DeepCopy() *MetadataKeyPath {
	if in == nil {
		return nil
	}
	out := new(MetadataKeyPath)
	in.DeepCopyInto(out)
	return out
}
