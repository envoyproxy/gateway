...
const (
	...
	RouteReasonRouteRulesOverlap    gwapiv1.RouteConditionReason = "RouteRulesOverlap"
	RouteConditionRouteRulesOverlap gwapiv1.RouteConditionType   = "RouteRulesOverlap"
	...
	// RouteReasonNameContainsDots is used with the "Warning" condition when the route
	...
	RouteReasonNameContainsDots gwapiv1.RouteConditionReason = "NameContainsDots"
)
