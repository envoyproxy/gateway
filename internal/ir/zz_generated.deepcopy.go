...
func (in *ExtAuth) DeepCopyInto(out *ExtAuth) {
	*out = *in
	...
	if in.TypedMetadataContextNamespaces != nil {
		in, out := &in.TypedMetadataContextNamespaces, &out.TypedMetadataContextNamespaces
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.RouteMetadataContextNamespaces != nil {
		in, out := &in.RouteMetadataContextNamespaces, &out.RouteMetadataContextNamespaces
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.RouteTypedMetadataContextNamespaces != nil {
		in, out := &in.RouteTypedMetadataContextNamespaces, &out.RouteTypedMetadataContextNamespaces
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
