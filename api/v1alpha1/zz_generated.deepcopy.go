...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WasmCodeFetchBackOffPolicy) DeepCopyInto(out *WasmCodeFetchBackOffPolicy) {
	*out = *in
	if in.BaseInterval != nil {
		in, out := &in.BaseInterval, &out.BaseInterval
		*out = new(v1.Duration)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WasmCodeFetchBackOffPolicy.
func (in *WasmCodeFetchBackOffPolicy) DeepCopy() *WasmCodeFetchBackOffPolicy {
	if in == nil {
		return nil
	}
	out := new(WasmCodeFetchBackOffPolicy)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WasmCodeFetchRetryPolicy) DeepCopyInto(out *WasmCodeFetchRetryPolicy) {
	*out = *in
	if in.NumRetries != nil {
		in, out := &in.NumRetries, &out.NumRetries
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WasmCodeFetchRetryPolicy.
func (in *WasmCodeFetchRetryPolicy) DeepCopy() *WasmCodeFetchRetryPolicy {
	if in == nil {
		return nil
	}
	out := new(WasmCodeFetchRetryPolicy)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WasmCodeSource) DeepCopyInto(out *WasmCodeSource) {
	*out = *in
	...
	if in.FetchRetryPolicy != nil {
		in, out := &in.FetchRetryPolicy, &out.FetchRetryPolicy
		*out = new(WasmCodeFetchRetryPolicy)
		(*in).DeepCopyInto(*out)
	}
}
