...
| `cookieConfig` | _[OIDCCookieConfig](#oidccookieconfig)_ |  false  |  | CookieConfigs allows overriding the SameSite attribute for OIDC cookies.<br />If a specific cookie is not configured, it will use the "Lax" SameSite policy by default. |
