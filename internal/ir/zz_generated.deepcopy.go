...
func (in *JWTProvider) DeepCopyInto(out *JWTProvider) {
	*out = *in
	...
	if in.RemoteJWKSBackend != nil {
		in, out := &in.RemoteJWKSBackend, &out.RemoteJWKSBackend
		*out = new(RemoteJWKSBackend)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RemoteJWKSBackend) DeepCopyInto(out *RemoteJWKSBackend) {
	*out = *in
	if in.Destination != nil {
		in, out := &in.Destination, &out.Destination
		*out = new(RouteDestination)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RemoteJWKSBackend.
func (in *RemoteJWKSBackend) DeepCopy() *RemoteJWKSBackend {
	if in == nil {
		return nil
	}
	out := new(RemoteJWKSBackend)
