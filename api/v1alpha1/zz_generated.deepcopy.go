...
func (in *EnvoyGatewayKubernetesProvider) DeepCopyInto(out *EnvoyGatewayKubernetesProvider) {
	*out = *in
	...
	if in.StatsdExporter != nil {
		in, out := &in.StatsdExporter, &out.StatsdExporter
		*out = new(StatsdExporter)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StatsdExporter) DeepCopyInto(out *StatsdExporter) {
	*out = *in
	if in.Image != nil {
		in, out := &in.Image, &out.Image
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StatsdExporter.
func (in *StatsdExporter) DeepCopy() *StatsdExporter {
	if in == nil {
		return nil
	}
	out := new(StatsdExporter)
