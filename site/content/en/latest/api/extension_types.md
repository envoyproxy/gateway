...
| `enableRetryAfterHeader` | _boolean_ |  false  |  | EnableRetryAfterHeader configures Envoy Proxy to emit the "Retry-After" response header<br />on rate-limited 429 responses.<br />Defaults to false. |
