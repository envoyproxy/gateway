...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RequestSizeLimit) DeepCopyInto(out *RequestSizeLimit) {
	*out = *in
	if in.Size != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RequestSizeLimit.
func (in *RequestSizeLimit) DeepCopy() *RequestSizeLimit {
	if in == nil {
		return nil
	}
	out := new(RequestSizeLimit)
