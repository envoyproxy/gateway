...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TLSBundle) DeepCopyInto(out *TLSBundle) {
	*out = *in
	if in.CertificateByte != nil {
		in, out := &in.CertificateByte, &out.CertificateByte
		*out = make([]byte, len(*in))
		copy(*out, *in)
	}
	if in.PrivateKeyByte != nil {
		in, out := &in.PrivateKeyByte, &out.PrivateKeyByte
		*out = make([]byte, len(*in))
		copy(*out, *in)
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TLSBundle.
func (in *TLSBundle) DeepCopy() *TLSBundle {
	if in == nil {
		return nil
	}
	out := new(TLSBundle)
