...
// +kubebuilder:validation:XValidation:rule="!has(self.requestBuffer) || !has(self.decompressor) || self.decompressor.size() == 0", message="requestBuffer cannot be used together with decompressor"
