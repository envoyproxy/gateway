...
func (in *EnvoyProxySpec) DeepCopyInto(out *EnvoyProxySpec) {
	*out = *in
	...
	if in.FilterPriority != nil {
		in, out := &in.FilterPriority, &out.FilterPriority
		*out = make([]FilterPriority, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FilterPriority) DeepCopyInto(out *FilterPriority) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FilterPriority.
func (in *FilterPriority) DeepCopy() *FilterPriority {
	if in == nil {
		return nil
	}
	out := new(FilterPriority)
	in.DeepCopyInto(out)
	return out
}
