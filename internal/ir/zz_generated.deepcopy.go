...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DynamicModuleLB) DeepCopyInto(out *DynamicModuleLB) {
	*out = *in
	if in.Config != nil {
		in, out := &in.Config, &out.Config
		*out = new(apiextensionsv1.JSON)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DynamicModuleLB.
func (in *DynamicModuleLB) DeepCopy() *DynamicModuleLB {
	if in == nil {
		return nil
	}
	out := new(DynamicModuleLB)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LoadBalancer) DeepCopyInto(out *LoadBalancer) {
	*out = *in
	...
	if in.DynamicModuleLB != nil {
		in, out := &in.DynamicModuleLB, &out.DynamicModuleLB
		*out = new(DynamicModuleLB)
		(*in).DeepCopyInto(*out)
	}
	if in.PreferLocal != nil {
