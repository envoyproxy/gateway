...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPWasmCodeFetchRetryPolicy) DeepCopyInto(out *HTTPWasmCodeFetchRetryPolicy) {
	*out = *in
	if in.BaseInterval != nil {
		in, out := &in.BaseInterval, &out.BaseInterval
		*out = new(metav1.Duration)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPWasmCodeFetchRetryPolicy.
func (in *HTTPWasmCodeFetchRetryPolicy) DeepCopy() *HTTPWasmCodeFetchRetryPolicy {
	if in == nil {
		return nil
	}
	out := new(HTTPWasmCodeFetchRetryPolicy)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Wasm) DeepCopyInto(out *Wasm) {
	*out = *in
	...
	if in.HTTPCodeFetchRetryPolicy != nil {
		in, out := &in.HTTPCodeFetchRetryPolicy, &out.HTTPCodeFetchRetryPolicy
		*out = new(HTTPWasmCodeFetchRetryPolicy)
		(*in).DeepCopyInto(*out)
	}
}
