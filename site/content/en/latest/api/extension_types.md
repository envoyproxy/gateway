...
| `envoyPDB` | _[KubernetesPodDisruptionBudgetSpec](#kubernetespoddisruptionbudgetspec)_ |  false  | EnvoyPDB allows to control the pod disruption budget of ab Envoy Proxy. |
