...
const (
	...
	// DefaultShutdownManagerCPUResourceLimits for shutdown manager cpu resource limit
	DefaultShutdownManagerCPUResourceLimits = "100m"
	...
	DefaultShutdownManagerMemoryResourceLimits = "1Gi"
