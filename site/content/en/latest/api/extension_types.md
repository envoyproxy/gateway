...
| Field | Type | Required | Description |
| ---   | ---  | ---      | ---         |
| `clientSelector` | _[ClientSelector](#clientselector)_ |  true  | ClientSelector contains the client selector configuration. All selectors are AND'd together and only if all selector are valid the Action is performed. |
