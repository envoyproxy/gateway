...
func (in *OIDC) DeepCopyInto(out *OIDC) {
	*out = *in
	...
	if in.PostLogoutRedirect != nil {
		...
		*out = new(OIDCPostLogoutRedirect)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OIDCPostLogoutRedirect) DeepCopyInto(out *OIDCPostLogoutRedirect) {
	*out = *in
	if in.URI != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OIDCPostLogoutRedirect.
func (in *OIDCPostLogoutRedirect) DeepCopy() *OIDCPostLogoutRedirect {
	if in == nil {
		return nil
	}
	out := new(OIDCPostLogoutRedirect)
