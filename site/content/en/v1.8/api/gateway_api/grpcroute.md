...
[grpcroute]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.5/spec/#grpcroute
[grpcrouterule]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.5/spec/#grpcrouterule
[hostname]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.5/spec/#hostname
[rfc-3986]: https://tools.ietf.org/html/rfc3986
[matches]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.5/spec/#grpcroutematch
[filters]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.5/spec/#grpcroutefilter
[backendRef]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.5/spec/#grpcbackendref
[parentRef]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.5/spec/#parentreference
[name]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.5/spec/#sectionname
