...
| `luaValidation` | _[LuaValidation](#luavalidation)_ |  false  | Run | LuaValidation determines strictness of the Lua script validation for Lua EnvoyExtensionPolicies |
