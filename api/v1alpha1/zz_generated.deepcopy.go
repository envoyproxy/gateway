...
func (in *ExtAuth) DeepCopyInto(out *ExtAuth) {
	*out = *in
	...
	if in.AccessibleMetadata != nil {
		in, out := &in.AccessibleMetadata, &out.AccessibleMetadata
		*out = new(ExtAuthAccessibleMetadata)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExtAuthAccessibleMetadata) DeepCopyInto(out *ExtAuthAccessibleMetadata) {
	*out = *in
	...
	if in.TypedNamespaces != nil {
		in, out := &in.TypedNamespaces, &out.TypedNamespaces
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.RouteNamespaces != nil {
		in, out := &in.RouteNamespaces, &out.RouteNamespaces
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.RouteTypedNamespaces != nil {
		in, out := &in.RouteTypedNamespaces, &out.RouteTypedNamespaces
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExtAuthAccessibleMetadata.
func (in *ExtAuthAccessibleMetadata) DeepCopy() *ExtAuthAccessibleMetadata {
	if in == nil {
		return nil
	}
	out := new(ExtAuthAccessibleMetadata)
