...
func (in *OIDC) DeepCopyInto(out *OIDC) {
	*out = *in
	...
	if in.CookieConfigs != nil {
		in, out := &in.CookieConfigs, &out.CookieConfigs
		*out = new(OIDCCookieConfigs)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OIDCCookieConfigs) DeepCopyInto(out *OIDCCookieConfigs) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OIDCCookieConfigs.
func (in *OIDCCookieConfigs) DeepCopy() *OIDCCookieConfigs {
	if in == nil {
		return nil
	}
	out := new(OIDCCookieConfigs)
