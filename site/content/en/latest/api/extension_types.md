...
| `podDisruptionBudget` | _[KubernetesPodDisruptionBudgetSpec](#kubernetespoddisruptionbudgetspec)_ |  true  | PodDisruptionBudget allows to control the pod disruption budget of ab Envoy Proxy. |
...
| Field | Type | Required | Description |
| ---   | ---  | ---      | ---         |
| `minAvailable` | _[IntOrString](#intorstring)_ |  false  | MinAvailable specifies the minimum number of pods that must be available at all times during voluntary disruptions,<br />such as node drains or updates. This setting ensures that your envoy proxy maintains a certain level of availability<br />and resilience during maintenance operations. |
