...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GeoLocationPrincipal) DeepCopyInto(out *GeoLocationPrincipal) {
	*out = *in
	if in.Countries != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GeoLocationPrincipal.
func (in *GeoLocationPrincipal) DeepCopy() *GeoLocationPrincipal {
	if in == nil {
		return nil
	}
	out := new(GeoLocationPrincipal)
	in.DeepCopyInto(out)
	return out
}
