...
func SetSecurityPolicyCondition(c *egv1a1.SecurityPolicy, conditionType gwv1a2.PolicyConditionType, status metav1.ConditionStatus, reason gwv1a2.PolicyConditionReason, message string) {
...
func SetSecurityPolicyAccepted(s *egv1a1.SecurityPolicyStatus, message string) {
