...
func SetBackendTrafficPolicyCondition(c *egv1a1.BackendTrafficPolicy, conditionType gwv1a2.PolicyConditionType, status metav1.ConditionStatus, reason gwv1a2.PolicyConditionReason, message string) {
...
func SetBackendTrafficPolicyAcceptedIfUnset(s *egv1a1.BackendTrafficPolicyStatus, message string) {
