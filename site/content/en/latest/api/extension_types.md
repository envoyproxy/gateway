...
#### EnvoyProxyWasmCodeSource



EnvoyProxyWasmCodeSource references a Wasm module registered in EnvoyProxy.spec.wasmModules.
...
| Field | Type | Required | Default | Description |
| ---   | ---  | ---      | ---     | ---         |
| `type` | _[WasmCodeSourceType](#wasmcodesourcetype)_ |  true  |  | Type is the type of the source of the Wasm code.<br />Valid WasmCodeSourceType values are "HTTP", "Image", or "EnvoyProxy". |
...
| `EnvoyProxy` | EnvoyProxyWasmCodeSourceType loads Wasm code from a module registered on EnvoyProxy.<br /> | 
...
by EnvoyExtensionPolicy resources with an EnvoyProxy code source.
