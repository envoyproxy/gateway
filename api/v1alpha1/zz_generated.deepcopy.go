...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPCookieMatchFilter) DeepCopyInto(out *HTTPCookieMatchFilter) {
	*out = *in
	if in.Cookies != nil {
		in, out := &in.Cookies, &out.Cookies
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPCookieMatchFilter.
func (in *HTTPCookieMatchFilter) DeepCopy() *HTTPCookieMatchFilter {
	if in == nil {
		return nil
	}
	out := new(HTTPCookieMatchFilter)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HTTPRouteFilterSpec) DeepCopyInto(out *HTTPRouteFilterSpec) {
	*out = *in
	...
	if in.CookieMatch != nil {
		in, out := &in.CookieMatch, &out.CookieMatch
		*out = new(HTTPCookieMatchFilter)
		(*in).DeepCopyInto(*out)
	}
}
