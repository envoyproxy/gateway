...
func (in *Resources) DeepCopyInto(out *Resources) {
	*out = *in
	...
	if in.CorsFilters != nil {
		in, out := &in.CorsFilters, &out.CorsFilters
		*out = make([]*v1alpha1.CorsFilter, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(v1alpha1.CorsFilter)
				(*in).DeepCopyInto(*out)
			}
		}
	}
	if in.GrpcJSONTranscoderFilters != nil {
		...
		*out = make([]*v1alpha1.GrpcJSONTranscoderFilter, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(v1alpha1.GrpcJSONTranscoderFilter)
				(*in).DeepCopyInto(*out)
			}
		}
	}
