...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubernetesMode) DeepCopyInto(out *KubernetesMode) {
	*out = *in
	if in.Watch != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubernetesMode.
func (in *KubernetesMode) DeepCopy() *KubernetesMode {
	if in == nil {
		return nil
	}
	out := new(KubernetesMode)
