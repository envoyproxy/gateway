...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TracingOperation) DeepCopyInto(out *TracingOperation) {
	*out = *in
	if in.Server != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TracingOperation.
func (in *TracingOperation) DeepCopy() *TracingOperation {
	if in == nil {
		return nil
	}
	out := new(TracingOperation)
