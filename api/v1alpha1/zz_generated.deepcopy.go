...
func (in *DynamicModule) DeepCopyInto(out *DynamicModule) {
	*out = *in
	in.DynamicModuleRef.DeepCopyInto(&out.DynamicModuleRef)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DynamicModuleRef) DeepCopyInto(out *DynamicModuleRef) {
	*out = *in
	if in.ImplementationName != nil {
		in, out := &in.ImplementationName, &out.ImplementationName
		*out = new(string)
		**out = **in
	}
	if in.Config != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DynamicModuleRef.
func (in *DynamicModuleRef) DeepCopy() *DynamicModuleRef {
	if in == nil {
		return nil
	}
	out := new(DynamicModuleRef)
	in.DeepCopyInto(out)
	return out
}
