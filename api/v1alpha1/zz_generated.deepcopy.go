...
func (in *ClientTrafficPolicySpec) DeepCopyInto(out *ClientTrafficPolicySpec) {
	*out = *in
	...
	if in.OriginalIPDetection != nil {
		in, out := &in.OriginalIPDetection, &out.OriginalIPDetection
		*out = new(OriginalIPDetectionSettings)
		(*in).DeepCopyInto(*out)
	}
	if in.HTTP3 != nil {
...
func (in *CustomHeaderExtensionSettings) DeepCopyInto(out *CustomHeaderExtensionSettings) {
	*out = *in
	if in.RejectWithStatus != nil {
		in, out := &in.RejectWithStatus, &out.RejectWithStatus
		*out = new(uint32)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OriginalIPDetectionExtensions) DeepCopyInto(out *OriginalIPDetectionExtensions) {
	*out = *in
	...
	if in.Xff != nil {
		...
		*out = new(XffExtensionSettings)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OriginalIPDetectionExtensions.
func (in *OriginalIPDetectionExtensions) DeepCopy() *OriginalIPDetectionExtensions {
	if in == nil {
		return nil
	}
	out := new(OriginalIPDetectionExtensions)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OriginalIPDetectionSettings) DeepCopyInto(out *OriginalIPDetectionSettings) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OriginalIPDetectionSettings.
func (in *OriginalIPDetectionSettings) DeepCopy() *OriginalIPDetectionSettings {
	if in == nil {
		return nil
	}
	out := new(OriginalIPDetectionSettings)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *XffExtensionSettings) DeepCopyInto(out *XffExtensionSettings) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new XffExtensionSettings.
func (in *XffExtensionSettings) DeepCopy() *XffExtensionSettings {
	if in == nil {
		return nil
	}
	out := new(XffExtensionSettings)
