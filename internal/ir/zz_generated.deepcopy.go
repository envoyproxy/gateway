...
func (in *HTTPTransformation) DeepCopyInto(out *HTTPTransformation) {
	*out = *in
	if in.SetHeaders != nil {
		...
		*out = make([]TransformHeader, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TransformHeader) DeepCopyInto(out *TransformHeader) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TransformHeader.
func (in *TransformHeader) DeepCopy() *TransformHeader {
	if in == nil {
		return nil
	}
	out := new(TransformHeader)
	in.DeepCopyInto(out)
	return out
}
