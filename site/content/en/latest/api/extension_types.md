...
| `url` | _string_ |  false  |  | URL of the RateLimit Service. Used by custom resource providers.<br />Must be a grpc:// URL with an explicit host and port, e.g. grpc://example.com:50051.<br />The default is the Kubernetes service deployed by the Kubernetes Infrastructure manager. |
