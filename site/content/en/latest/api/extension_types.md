...
| `endpointRoutingDisabled` | _boolean_ |  false  | EndpointRoutingDisabled can be set to true to use<br />the Service Cluster IP for routing to the backend<br />instead. |
