...
| `proxyTopologyInjector` | _[EnvoyGatewayTopologyInjector](#envoygatewaytopologyinjector)_ |  true  |  | TopologyInjector defines the configuration for topology injector MutatatingWebhookConfiguration |
