...
| `errorUtilizationPenalty` | _float_ |  false  |  | The multiplier used to adjust endpoint weights with the error rate calculated as eps/qps.<br />Must be non-negative. Default is 1.0. |
