...
kube-demo: ## Deploy a demo backend service, gatewayclass, gateway and httproute resource and test the configuration.
	kubectl apply -f examples/kubernetes/httpbin.yaml -n default
	kubectl apply -f examples/kubernetes/gatewayclass.yaml -n default
	kubectl apply -f examples/kubernetes/gateway.yaml -n default
	kubectl apply -f examples/kubernetes/httproute.yaml -n default
...
kube-demo-undeploy: ## Uninstall the Kubernetes resources installed from the `make kube-demo` command.
	kubectl delete -f examples/kubernetes/httproute.yaml -n default
	kubectl delete -f examples/kubernetes/gateway.yaml -n default
	kubectl delete -f examples/kubernetes/gatewayclass.yaml -n default
	kubectl delete -f examples/kubernetes/httpbin.yaml -n default
