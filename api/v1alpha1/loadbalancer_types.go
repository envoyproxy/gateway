...
// +kubebuilder:validation:XValidation:rule="self.type in ['Random', 'ConsistentHash', 'DynamicModule'] ? !has(self.slowStart) : true ",message="SlowStart is not supported for Random, ConsistentHash, and DynamicModule load balancers."
