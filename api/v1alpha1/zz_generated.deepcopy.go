...
func (in *BackendTrafficPolicySpec) DeepCopyInto(out *BackendTrafficPolicySpec) {
	*out = *in
	...
	if in.UpgradeConfigs != nil {
		...
		*out = make([]*BackendUpgradeConfig, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(BackendUpgradeConfig)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BackendUpgradeConfig) DeepCopyInto(out *BackendUpgradeConfig) {
	*out = *in
	if in.Disabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackendUpgradeConfig.
func (in *BackendUpgradeConfig) DeepCopy() *BackendUpgradeConfig {
	if in == nil {
		return nil
	}
	out := new(BackendUpgradeConfig)
