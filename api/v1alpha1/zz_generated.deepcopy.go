...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomJWTClaim) DeepCopyInto(out *CustomJWTClaim) {
	*out = *in
	if in.ValueType != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomJWTClaim.
func (in *CustomJWTClaim) DeepCopy() *CustomJWTClaim {
	if in == nil {
		return nil
	}
	out := new(CustomJWTClaim)
	in.DeepCopyInto(out)
	return out
}
