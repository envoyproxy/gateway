...
func (in *RateLimitRule) DeepCopyInto(out *RateLimitRule) {
	*out = *in
	...
	out.Limit = in.Limit
	if in.RequestUsage != nil {
		in, out := &in.RequestUsage, &out.RequestUsage
		*out = new(RateLimitUsage)
		(*in).DeepCopyInto(*out)
	}
	if in.ResponseUsage != nil {
		in, out := &in.ResponseUsage, &out.ResponseUsage
		*out = new(RateLimitUsage)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RateLimitUsage) DeepCopyInto(out *RateLimitUsage) {
	*out = *in
	if in.Number != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RateLimitUsage.
func (in *RateLimitUsage) DeepCopy() *RateLimitUsage {
	if in == nil {
		return nil
	}
	out := new(RateLimitUsage)
