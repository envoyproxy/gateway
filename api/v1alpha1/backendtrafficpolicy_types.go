...
// +kubebuilder:validation:XValidation:rule="has(self.targetRef) ? (self.targetRef.group == 'gateway.networking.k8s.io' && self.targetRef.kind in ['Gateway', 'HTTPRoute', 'GRPCRoute', 'UDPRoute', 'TCPRoute', 'TLSRoute']) || (self.targetRef.group == '' && self.targetRef.kind == 'Service') || (self.targetRef.group == 'multicluster.x-k8s.io' && self.targetRef.kind == 'ServiceImport') || (self.targetRef.group == 'gateway.envoyproxy.io' && self.targetRef.kind == 'Backend') : true", message="invalid targetRef group/kind combination"
// +kubebuilder:validation:XValidation:rule="has(self.targetRefs) ? self.targetRefs.all(ref, (ref.group == 'gateway.networking.k8s.io' && ref.kind in ['Gateway', 'HTTPRoute', 'GRPCRoute', 'UDPRoute', 'TCPRoute', 'TLSRoute']) || (ref.group == '' && ref.kind == 'Service') || (ref.group == 'multicluster.x-k8s.io' && ref.kind == 'ServiceImport') || (ref.group == 'gateway.envoyproxy.io' && ref.kind == 'Backend')) : true", message="invalid targetRefs group/kind combination"
