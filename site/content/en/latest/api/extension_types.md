...
| `connectionBufferLimitBytes` | _[Quantity](#quantity)_ |  false  | ConnectionBufferLimitBytes Soft limit on size of the cluster’s connections read and write buffers.<br />If unspecified, an implementation defined default is applied (32768 bytes).<br />For example, 20Mi, 1Gi, 256Ki etc.<br />Note: that when the suffix is not provided, the value is interpreted as bytes. |
