...
| `bufferLimit` | _integer_ |  false  | BufferLimitBytes provides configuration for the maximum buffer size in bytes for each incoming connection. Default: 32768 bytes. |
