...
| `enableRetryAfterHeader` | _boolean_ |  false  |  | EnableRetryAfterHeader configures Envoy Proxy to emit the "Retry-After" response header<br />when rate limiting is enabled. |
