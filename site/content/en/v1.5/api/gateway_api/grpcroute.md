...
[grpcrouterule]: https://gateway-api.sigs.k8s.io/reference/1.3/spec#grpcrouterule
[hostname]: https://gateway-api.sigs.k8s.io/reference/1.3/spec#hostname
[rfc-3986]: https://tools.ietf.org/html/rfc3986
[matches]: https://gateway-api.sigs.k8s.io/reference/1.3/spec#grpcroutematch
[filters]: https://gateway-api.sigs.k8s.io/reference/1.3/spec#grpcroutefilter
[backendRef]: https://gateway-api.sigs.k8s.io/reference/1.3/spec#grpcbackendref
[parentRef]: https://gateway-api.sigs.k8s.io/reference/1.3/spec#parentref
[name]: https://gateway-api.sigs.k8s.io/reference/1.3/spec#sectionname
