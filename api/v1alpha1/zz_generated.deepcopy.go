...
func (in *SchemeHeaderTransformation) DeepCopyInto(out *SchemeHeaderTransformation) {
	*out = *in
	if in.Mode != nil {
		...
		*out = new(SchemeHeaderTransformationMode)
		**out = **in
	}
	if in.Scheme != nil {
		in, out := &in.Scheme, &out.Scheme
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SchemeHeaderTransformation.
func (in *SchemeHeaderTransformation) DeepCopy() *SchemeHeaderTransformation {
	if in == nil {
		return nil
	}
	out := new(SchemeHeaderTransformation)
