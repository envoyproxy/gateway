...
```shell
cat <<EOF | egctl x translate --from gateway-api --to xds -o json -f -
apiVersion: gateway.networking.k8s.io/v1beta1
kind: GatewayClass
metadata:
  name: eg
...
In the below example, we will translate the Kubernetes resources (including the Gateway API resources) into xDS
resources with all xds resources.

```shell
cat <<EOF | egctl x translate --from gateway-api --to xds -t all -f -
apiVersion: gateway.networking.k8s.io/v1beta1
kind: GatewayClass
metadata:
  name: eg
...
In the below example, we will translate the Kubernetes resources (including the Gateway API resources) into xDS
resources with bootstrap config.

```shell
cat <<EOF | egctl x translate --from gateway-api --to xds -t bootstrap -f -
apiVersion: gateway.networking.k8s.io/v1beta1
kind: GatewayClass
metadata:
  name: eg
...
In the below example, we will translate the Kubernetes resources (including the Gateway API resources) into xDS
resources with cluster config.

```shell
cat <<EOF | egctl x translate --from gateway-api --to xds -t cluster -f -
apiVersion: gateway.networking.k8s.io/v1beta1
kind: GatewayClass
metadata:
  name: eg
...
In the below example, we will translate the Kubernetes resources (including the Gateway API resources) into xDS
resources with listener config.

```shell
cat <<EOF | egctl x translate --from gateway-api --to xds -t listener -f -
apiVersion: gateway.networking.k8s.io/v1beta1
kind: GatewayClass
metadata:
  name: eg
