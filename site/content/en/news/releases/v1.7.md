...
- **SecurityPolicy OAuth2 Filter** Added The SecurityPolicy name has been added to the stat prefix for oauth2 filter metrics to provide better granularity. Example: http.https-10443.securitypolicy/default/oidc-example.oauth_success: 0.
- **Invalid Filters** Returning 500 direct responses for HTTPRoute and GRPCRoute with invalid filters.
