...
type XDSHookClient interface {
	...
	PostRouteModifyHook(route *route.Route, routeHostnames []string, extensionResources []*unstructured.Unstructured, extensionPolicies []*unstructured.Unstructured) (*route.Route, error)
	...
	// to it. extensionPolicies contains all ExtensionServerPolicies targeting routes within this virtual host.
	PostVirtualHostModifyHook(vh *route.VirtualHost, extensionPolicies []*unstructured.Unstructured) (*route.VirtualHost, error)
