...
func (in *EnvoyGatewaySpec) DeepCopyInto(out *EnvoyGatewaySpec) {
	*out = *in
	...
	if in.WASMServer != nil {
		in, out := &in.WASMServer, &out.WASMServer
		*out = new(WASMServer)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WASMServer) DeepCopyInto(out *WASMServer) {
	*out = *in
	if in.Address != nil {
		in, out := &in.Address, &out.Address
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WASMServer.
func (in *WASMServer) DeepCopy() *WASMServer {
	if in == nil {
		return nil
	}
	out := new(WASMServer)
