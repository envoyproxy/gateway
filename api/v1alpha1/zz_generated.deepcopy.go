...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BufferStreamConfig) DeepCopyInto(out *BufferStreamConfig) {
	*out = *in
	if in.Behavior != nil {
		in, out := &in.Behavior, &out.Behavior
		*out = new(BufferStreamBehavior)
		**out = **in
	}
	if in.MemoryBufferLimit != nil {
		in, out := &in.MemoryBufferLimit, &out.MemoryBufferLimit
		x := (*in).DeepCopy()
		*out = &x
	}
	if in.StorageBufferLimit != nil {
		in, out := &in.StorageBufferLimit, &out.StorageBufferLimit
		x := (*in).DeepCopy()
		*out = &x
	}
	if in.StorageBufferQueueHighWatermark != nil {
		in, out := &in.StorageBufferQueueHighWatermark, &out.StorageBufferQueueHighWatermark
		x := (*in).DeepCopy()
		*out = &x
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BufferStreamConfig.
func (in *BufferStreamConfig) DeepCopy() *BufferStreamConfig {
	if in == nil {
		return nil
	}
	out := new(BufferStreamConfig)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClientStreamBufferSettings) DeepCopyInto(out *ClientStreamBufferSettings) {
	*out = *in
	...
	if in.FileSystem != nil {
		...
		*out = new(FileSystemBuffers)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClientStreamBufferSettings.
func (in *ClientStreamBufferSettings) DeepCopy() *ClientStreamBufferSettings {
	if in == nil {
		return nil
	}
	out := new(ClientStreamBufferSettings)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClientTrafficPolicySpec) DeepCopyInto(out *ClientTrafficPolicySpec) {
	*out = *in
	...
	if in.StreamBufferSettings != nil {
		in, out := &in.StreamBufferSettings, &out.StreamBufferSettings
		*out = new(ClientStreamBufferSettings)
		(*in).DeepCopyInto(*out)
	}
	if in.HTTP1 != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FileManagerConfig) DeepCopyInto(out *FileManagerConfig) {
	*out = *in
	if in.ID != nil {
		in, out := &in.ID, &out.ID
		*out = new(string)
	...
	in.ThreadPool.DeepCopyInto(&out.ThreadPool)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FileManagerConfig.
func (in *FileManagerConfig) DeepCopy() *FileManagerConfig {
	if in == nil {
		return nil
	}
	out := new(FileManagerConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FileManagerThreadPool) DeepCopyInto(out *FileManagerThreadPool) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FileManagerThreadPool.
func (in *FileManagerThreadPool) DeepCopy() *FileManagerThreadPool {
	if in == nil {
		return nil
	}
	out := new(FileManagerThreadPool)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FileSystemBuffers) DeepCopyInto(out *FileSystemBuffers) {
	*out = *in
	if in.Manager != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FileSystemBuffers.
func (in *FileSystemBuffers) DeepCopy() *FileSystemBuffers {
	if in == nil {
		return nil
	}
	out := new(FileSystemBuffers)
