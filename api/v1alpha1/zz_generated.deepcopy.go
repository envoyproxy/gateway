...
func (in *RateLimitRule) DeepCopyInto(out *RateLimitRule) {
	*out = *in
	...
	out.Limit = in.Limit
	if in.UsageSpecifier != nil {
		in, out := &in.UsageSpecifier, &out.UsageSpecifier
		*out = new(RateLimitUsageSpecifier)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RateLimitUsageSpecifier) DeepCopyInto(out *RateLimitUsageSpecifier) {
	*out = *in
	if in.Number != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RateLimitUsageSpecifier.
func (in *RateLimitUsageSpecifier) DeepCopy() *RateLimitUsageSpecifier {
	if in == nil {
		return nil
	}
	out := new(RateLimitUsageSpecifier)
