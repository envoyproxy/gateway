	...
	tests := []struct {
	...
	}{
		{
			...
			resources: []*resource.ControllerResources{
				{
					{
						GatewayClass: &gwapiv1.GatewayClass{Name: "class-1"},
					},
					{
						GatewayClass: &gwapiv1.GatewayClass{Name: "class-2"},
					},
				},
				{
					{
			...
			resources: []*resource.ControllerResources{
				{
					...
					},
					{
						GatewayClass: &gwapiv1.GatewayClass{Name: "class-2"},
						Gateways: []*gwapiv1.Gateway{
							{Name: "gateway-3", Namespace: "system"},
						},
					},
				},
				{
				...
				{
					{
						...
						Gateways: []*gwapiv1.Gateway{
							{Name: "gateway-1", Namespace: "default"},
							{Name: "gateway-2", Namespace: "default"},
							{Name: "gateway-3", Namespace: "test"},
						},
					},
					{
						GatewayClass: &gwapiv1.GatewayClass{Name: "class-2"},
						Gateways: []*gwapiv1.Gateway{
							{Name: "gateway-4", Namespace: "system"},
							{Name: "gateway-5", Namespace: "system"},
						},
					},
				},
				{
