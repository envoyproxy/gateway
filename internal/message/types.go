...
const (
	...
	// EndpointUpdatesMessageName is a message containing endpoint updates published
	// by the provider for the endpoint fast path
	EndpointUpdatesMessageName MessageName = "endpoint-updates"
