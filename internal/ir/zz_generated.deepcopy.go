...
func (in *DestinationSetting) DeepCopyInto(out *DestinationSetting) {
	*out = *in
	if in.HostOverrideConfig != nil {
		in, out := &in.HostOverrideConfig, &out.HostOverrideConfig
		*out = new(HostOverrideConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.Weight != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HostOverrideConfig) DeepCopyInto(out *HostOverrideConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HostOverrideConfig.
func (in *HostOverrideConfig) DeepCopy() *HostOverrideConfig {
	if in == nil {
		return nil
	}
	out := new(HostOverrideConfig)
