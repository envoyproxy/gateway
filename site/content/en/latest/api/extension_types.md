...
| `removeResponseHeaders` | _boolean_ |  false  | true | RemoveResponseHeaders removes the ORCA load report headers/trailers before sending the response to the client.<br />Defaults to true. |
