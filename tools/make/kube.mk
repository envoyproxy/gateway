...
ifeq ($(E2E_RUN_TEST),)
	...
	LAST_VERSION_TAG=$(shell git tag |grep -Eo 'v[0-9]+\.[0-9]+\.[0-9]+'|sort -r|head -n 1) go test $(E2E_TEST_ARGS) ./test/e2e/upgrade --gateway-class=upgrade --debug=true --cleanup-base-resources=$(E2E_CLEANUP)
else
