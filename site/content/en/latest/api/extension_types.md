...
| `telemetry` | _[BackendTelemetry](#backendtelemetry)_ |  false  |  | Telemetry configures the telemetry settings for the backend or HTTPRoute.<br />This will override the telemetry settings in the EnvoyProxy resource. |
