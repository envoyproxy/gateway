...
[ExtensionRef filters]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.4/spec/#localobjectreference
[ExtensionRef]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.4/spec/#localobjectreference
[ExtensionRefs]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.4/spec/#localobjectreference
[backendRefs]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.4/spec/#backendobjectreference
...
[v1]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.4/spec/
