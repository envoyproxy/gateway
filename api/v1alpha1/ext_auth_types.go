...
type ExtAuth struct {
	...
	// AccessibleMetadata defines options related to the sending of dynamic and static (xds) metadata.
	// These options define which metadata namespaces would be sent to the external authorization server.
