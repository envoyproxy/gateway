...
func (in *EnvoyGatewayKubernetesProvider) DeepCopyInto(out *EnvoyGatewayKubernetesProvider) {
	*out = *in
	...
	if in.RateLimit != nil {
		in, out := &in.RateLimit, &out.RateLimit
		*out = new(KubernetesRateLimitSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Watch != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubernetesRateLimitSpec) DeepCopyInto(out *KubernetesRateLimitSpec) {
	*out = *in
	if in.PDB != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubernetesRateLimitSpec.
func (in *KubernetesRateLimitSpec) DeepCopy() *KubernetesRateLimitSpec {
	if in == nil {
		return nil
	}
	out := new(KubernetesRateLimitSpec)
