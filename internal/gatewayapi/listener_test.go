			...
			expectedStatus: []expectedListenerStatus{
				{
					...
					message:      "The certificate SAN foo.example.com overlaps with the certificate SAN foo.example.com in listener listener-2. HTTP/2 requests will receive a 421 Misdirected Request response to prevent connection coalescing.",
				},
				{
					...
					status:       metav1.ConditionTrue,
					reason:       gwapiv1.ListenerReasonOverlappingCertificates,
					message:      "The certificate SAN foo.example.com overlaps with the certificate SAN foo.example.com in listener listener-1. HTTP/2 requests will receive a 421 Misdirected Request response to prevent connection coalescing.",
				},
			},
		},
		{
			...
			expectedStatus: []expectedListenerStatus{
				{
					...
					status:       metav1.ConditionTrue,
					reason:       gwapiv1.ListenerReasonOverlappingCertificates,
					message:      "The certificate SAN *.example.com overlaps with the certificate SAN foo.example.com in listener listener-2. HTTP/2 requests will receive a 421 Misdirected Request response to prevent connection coalescing.",
				},
				{
					listenerName: "listener-2",
					condition:    gwapiv1.ListenerConditionOverlappingTLSConfig,
					status:       metav1.ConditionTrue,
					reason:       gwapiv1.ListenerReasonOverlappingCertificates,
					message:      "The certificate SAN foo.example.com overlaps with the certificate SAN *.example.com in listener listener-1. HTTP/2 requests will receive a 421 Misdirected Request response to prevent connection coalescing.",
				},
			},
		},
		{
			...
			expectedStatus: []expectedListenerStatus{
				{
					...
					status:       metav1.ConditionTrue,
					reason:       gwapiv1.ListenerReasonOverlappingCertificates,
					message:      "The certificate SAN bar.example.org overlaps with the certificate SAN *.example.org in listener listener-2. HTTP/2 requests will receive a 421 Misdirected Request response to prevent connection coalescing.",
				},
				{
					listenerName: "listener-2",
					condition:    gwapiv1.ListenerConditionOverlappingTLSConfig,
					status:       metav1.ConditionTrue,
					reason:       gwapiv1.ListenerReasonOverlappingCertificates,
					message:      "The certificate SAN *.example.org overlaps with the certificate SAN bar.example.org in listener listener-1. HTTP/2 requests will receive a 421 Misdirected Request response to prevent connection coalescing.",
				},
			},
		},
	}
