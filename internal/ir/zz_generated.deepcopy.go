...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BackendPolicyConnection) DeepCopyInto(out *BackendPolicyConnection) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackendPolicyConnection.
func (in *BackendPolicyConnection) DeepCopy() *BackendPolicyConnection {
	if in == nil {
		return nil
	}
	out := new(BackendPolicyConnection)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Wasm) DeepCopyInto(out *Wasm) {
	*out = *in
	...
	if in.HTTPWasmCode != nil {
		in, out := &in.HTTPWasmCode, &out.HTTPWasmCode
