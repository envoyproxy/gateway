...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProxyServiceCluster) DeepCopyInto(out *ProxyServiceCluster) {
	*out = *in
	if in.Destination != nil {
		in, out := &in.Destination, &out.Destination
		*out = new(DestinationSetting)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProxyServiceCluster.
func (in *ProxyServiceCluster) DeepCopy() *ProxyServiceCluster {
	if in == nil {
		return nil
	}
	out := new(ProxyServiceCluster)
	in.DeepCopyInto(out)
	return out
}
