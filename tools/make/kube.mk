...
e2e-remote-infra: KUBE_DEPLOY_PROFILE = remote-infra
...
run-e2e-remote-infra:
	@$(LOG_TARGET)
	cd test && go test $(E2E_TEST_ARGS) ./e2e/remote_infra $(E2E_TEST_SUITE_ARGS) --gateway-class=remote-infra --cleanup-base-resources=$(E2E_CLEANUP)
