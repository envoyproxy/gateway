...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TLSFile) DeepCopyInto(out *TLSFile) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TLSFile.
func (in *TLSFile) DeepCopy() *TLSFile {
	if in == nil {
		return nil
	}
	out := new(TLSFile)
