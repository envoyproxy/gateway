...
type Resources struct {
	...
	ClusterTrustBundles []*certificatesv1a1.ClusterTrustBundle `json:"clusterTrustBundles,omitempty" yaml:"clusterTrustBundles,omitempty"`
...
func (r *Resources) GetClusterTrustBundle(name string) *certificatesv1a1.ClusterTrustBundle {
