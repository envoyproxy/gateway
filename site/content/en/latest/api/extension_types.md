...
| `percentage` | _[Fraction](https://gateway-api.sigs.k8s.io/reference/1.5/spec/#fraction)_ |  false  |  | Percentage controls what percentage of requests are sent through this ExtProc extension.<br />When not specified, 100% of requests are sent through the extension. |
...
| `percentage` | _[Fraction](https://gateway-api.sigs.k8s.io/reference/1.5/spec/#fraction)_ |  false  |  | Percentage controls what percentage of requests are sent through this Lua extension.<br />When not specified, 100% of requests are sent through the extension. |
...
| `percentage` | _[Fraction](https://gateway-api.sigs.k8s.io/reference/1.5/spec/#fraction)_ |  false  |  | Percentage controls what percentage of requests are sent through this Wasm extension.<br />When not specified, 100% of requests are sent through the extension. |
