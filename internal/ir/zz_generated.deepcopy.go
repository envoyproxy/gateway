...
func (in *HTTPListener) DeepCopyInto(out *HTTPListener) {
	*out = *in
	in.TCPBasedListenerDetails.DeepCopyInto(&out.TCPBasedListenerDetails)
	if in.Hostnames != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TCPBasedListenerDetails) DeepCopyInto(out *TCPBasedListenerDetails) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TCPBasedListenerDetails.
func (in *TCPBasedListenerDetails) DeepCopy() *TCPBasedListenerDetails {
	if in == nil {
		return nil
	}
	out := new(TCPBasedListenerDetails)
	in.DeepCopyInto(out)
	return out
}
