			...
			expectedStatus: []expectedListenerStatus{
				{
					...
					message:      "The certificate san foo.example.com overlaps with the certificate san foo.example.com in listener listener-2",
				},
				{
					...
					status:       metav1.ConditionTrue,
					reason:       gwapiv1.ListenerReasonOverlappingCertificates,
					message:      "The certificate san foo.example.com overlaps with the certificate san foo.example.com in listener listener-1",
				},
			},
		},
		{
			...
			expectedStatus: []expectedListenerStatus{
				{
					...
					status:       metav1.ConditionTrue,
					reason:       gwapiv1.ListenerReasonOverlappingCertificates,
					message:      "The certificate san *.example.com overlaps with the certificate san foo.example.com in listener listener-2",
				},
				{
					listenerName: "listener-2",
					condition:    gwapiv1.ListenerConditionOverlappingTLSConfig,
					status:       metav1.ConditionTrue,
					reason:       gwapiv1.ListenerReasonOverlappingCertificates,
					message:      "The certificate san foo.example.com overlaps with the certificate san *.example.com in listener listener-1",
				},
			},
		},
		{
			...
			expectedStatus: []expectedListenerStatus{
				{
					...
					status:       metav1.ConditionTrue,
					reason:       gwapiv1.ListenerReasonOverlappingCertificates,
					message:      "The certificate san bar.example.org overlaps with the certificate san *.example.org in listener listener-2",
				},
				{
					listenerName: "listener-2",
					condition:    gwapiv1.ListenerConditionOverlappingTLSConfig,
					status:       metav1.ConditionTrue,
					reason:       gwapiv1.ListenerReasonOverlappingCertificates,
					message:      "The certificate san *.example.org overlaps with the certificate san bar.example.org in listener listener-1",
				},
			},
		},
	}
