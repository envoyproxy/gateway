...
The [ExternalDNS](https://kubernetes-sigs.github.io/external-dns/v0.5.0/) controller maintains DNS records based on Kubernetes resources.
...
[The tutorial on Gateway API](https://kubernetes-sigs.github.io/external-dns/v0.5.0/tutorials/gateway-api/) uses kubectl.
