...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OtherNameMatch) DeepCopyInto(out *OtherNameMatch) {
	*out = *in
	in.StringMatch.DeepCopyInto(&out.StringMatch)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OtherNameMatch.
func (in *OtherNameMatch) DeepCopy() *OtherNameMatch {
	if in == nil {
		return nil
	}
	out := new(OtherNameMatch)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SubjectAltNames) DeepCopyInto(out *SubjectAltNames) {
	*out = *in
	...
	if in.OtherNames != nil {
		...
		*out = make([]OtherNameMatch, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
