...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RateLimitTraceProvider) DeepCopyInto(out *RateLimitTraceProvider) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RateLimitTraceProvider.
func (in *RateLimitTraceProvider) DeepCopy() *RateLimitTraceProvider {
	if in == nil {
		return nil
	}
	out := new(RateLimitTraceProvider)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RateLimitTracing) DeepCopyInto(out *RateLimitTracing) {
	*out = *in
	if in.TracingSampleRate != nil {
		in, out := &in.TracingSampleRate, &out.TracingSampleRate
		*out = new(float64)
		**out = **in
	}
	if in.Provider != nil {
