...
func (t *Translator) buildLua(
	...
	if envoyProxy != nil && envoyProxy.Spec.ExtensionPolicySettings != nil &&
		envoyProxy.Spec.ExtensionPolicySettings.DisableLuaValidation != nil &&
		*envoyProxy.Spec.ExtensionPolicySettings.DisableLuaValidation {
		return &ir.Lua{
			Name: name,
			Code: luaCode,
		}, nil
