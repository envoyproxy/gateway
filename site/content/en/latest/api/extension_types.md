...
| `envoyConfigMap` | _[KubernetesConfigMapSpec](#kubernetesconfigmapspec)_ |  false  |  | EnvoyConfigMap defines the desired state of the Envoy configmap resource. |
...
#### KubernetesConfigMapSpec



KubernetesConfigMapSpec defines the desired state of the Envoy configmap resource.
...
| Field | Type | Required | Default | Description |
| ---   | ---  | ---      | ---     | ---         |
| `name` | _string_ |  false  |  | Name of the ConfigMap.<br />When unset, this defaults to an autogenerated name. |
