...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TLSVersions) DeepCopyInto(out *TLSVersions) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TLSVersions.
func (in *TLSVersions) DeepCopy() *TLSVersions {
	if in == nil {
		return nil
	}
	out := new(TLSVersions)
