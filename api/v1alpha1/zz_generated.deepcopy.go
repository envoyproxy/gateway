...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPHeaderMatchFilter) DeepCopyInto(out *HTTPHeaderMatchFilter) {
	*out = *in
	if in.SafeRegex != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPHeaderMatchFilter.
func (in *HTTPHeaderMatchFilter) DeepCopy() *HTTPHeaderMatchFilter {
	if in == nil {
		return nil
	}
	out := new(HTTPHeaderMatchFilter)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HTTPRouteFilterSpec) DeepCopyInto(out *HTTPRouteFilterSpec) {
	*out = *in
	...
	if in.HeaderMatches != nil {
		...
		*out = make([]HTTPHeaderMatchFilter, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
