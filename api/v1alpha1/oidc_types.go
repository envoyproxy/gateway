...
// +kubebuilder:validation:XValidation:rule="!has(self.authorizationEndpoint) || !has(self.authorizationEndpointRef)", message="only one of authorizationEndpoint or authorizationEndpointRef must be set"
// +kubebuilder:validation:XValidation:rule="!has(self.tokenEndpoint) || !has(self.tokenEndpointRef)", message="only one of tokenEndpoint or tokenEndpointRef must be set"
// +kubebuilder:validation:XValidation:rule="!has(self.endSessionEndpoint) || !has(self.endSessionEndpointRef)", message="only one of endSessionEndpoint or endSessionEndpointRef must be set"
type OIDCProvider struct {
	...
	// IssuerRef defines the OIDC Provider's issuer identifier as a reference to a secret or configmap.
	//
	// Only one of issuer or issuerRef must be set.
	...
	// +optional
	IssuerRef *LocalObjectKeyReference `json:"issuerRef,omitempty"`

	// The OIDC Provider's [authorization endpoint](https://openid.net/specs/openid-connect-core-1_0.html#AuthorizationEndpoint).
	// If not provided, EG will try to discover it from the provider's [Well-Known Configuration Endpoint](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderConfigurationResponse).
	//
	// Only one of authorizationEndpoint or authorizationEndpointRef must be set.
	// +optional
	AuthorizationEndpoint *string `json:"authorizationEndpoint,omitempty"`

	// AuthorizationEndpointRef defines the OIDC Provider's authorization endpoint as a reference to a secret or configmap.
	//
	// Only one of authorizationEndpoint or authorizationEndpointRef must be set.
	// +kubebuilder:validation:XValidation:rule="self.kind in ['ConfigMap', 'Secret'] && self.group in ['', 'v1']",message="Only a reference to an object of kind ConfigMap or Secret belonging to default v1 API group is supported."
	// +optional
	AuthorizationEndpointRef *LocalObjectKeyReference `json:"authorizationEndpointRef,omitempty"`

	// The OIDC Provider's [token endpoint](https://openid.net/specs/openid-connect-core-1_0.html#TokenEndpoint).
	// If not provided, EG will try to discover it from the provider's [Well-Known Configuration Endpoint](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderConfigurationResponse).
	//
	// Only one of tokenEndpoint or tokenEndpointRef must be set.
	// +optional
	TokenEndpoint *string `json:"tokenEndpoint,omitempty"`

	// TokenEndpointRef defines the OIDC Provider's token endpoint as a reference to a secret or configmap.
	//
	// Only one of tokenEndpoint or tokenEndpointRef must be set.
	// +kubebuilder:validation:XValidation:rule="self.kind in ['ConfigMap', 'Secret'] && self.group in ['', 'v1']",message="Only a reference to an object of kind ConfigMap or Secret belonging to default v1 API group is supported."
	// +optional
	TokenEndpointRef *LocalObjectKeyReference `json:"tokenEndpointRef,omitempty"`
	...
	//
	// Only one of endSessionEndpoint or endSessionEndpointRef must be set.
	// +optional
	EndSessionEndpoint *string `json:"endSessionEndpoint,omitempty"`

	// EndSessionEndpointRef defines the OIDC Provider's end session endpoint as a reference to a secret or configmap.
	//
	// Only one of endSessionEndpoint or endSessionEndpointRef must be set.
	// +kubebuilder:validation:XValidation:rule="self.kind in ['ConfigMap', 'Secret'] && self.group in ['', 'v1']",message="Only a reference to an object of kind ConfigMap or Secret belonging to default v1 API group is supported."
	// +optional
	EndSessionEndpointRef *LocalObjectKeyReference `json:"endSessionEndpointRef,omitempty"`
}
