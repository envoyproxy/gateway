...
func TestBtpSpecHasClusterScopedFieldsExhaustive(t *testing.T) {
	expected := map[string]bool{
		...
		"DNS":            true,
		"HTTP2":          true,
		// MergeType and DefaultChildMergeType only select a merge strategy; they contribute no
		// cluster-scoped traffic setting of their own.
		"MergeType":             false,
		"DefaultChildMergeType": false,
		"RateLimit":             false,
