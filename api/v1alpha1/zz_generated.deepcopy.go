...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UDPClientTimeout) DeepCopyInto(out *UDPClientTimeout) {
	*out = *in
	if in.IdleTimeout != nil {
		in, out := &in.IdleTimeout, &out.IdleTimeout
		*out = new(v1.Duration)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UDPClientTimeout.
func (in *UDPClientTimeout) DeepCopy() *UDPClientTimeout {
	if in == nil {
		return nil
	}
	out := new(UDPClientTimeout)
