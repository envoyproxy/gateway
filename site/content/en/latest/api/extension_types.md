...
| `envoyProxyTemplate` | _[EnvoyProxySpec](#envoyproxyspec)_ |  false  |  | EnvoyProxyTemplate defines default settings for all Envoy Proxy resources.<br />These settings apply to EnvoyProxy resources that do not specify their own configuration.<br />Individual EnvoyProxy resource settings take precedence over these defaults. |
