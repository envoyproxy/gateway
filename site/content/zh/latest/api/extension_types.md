...
| `grpcMaxMessageSize` | _integer_ |  false  |  | MaxMessageSizeBytes defines the maximum message size in bytes that can be<br />sent to or received from the Extension Service.<br />Default: 4 MB |
