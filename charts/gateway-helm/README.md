...
| topologyWebhook.clusterDnsDomain | string | `"cluster.local"` |  |
| topologyWebhook.enabled | bool | `false` |  |
| topologyWebhook.keepTLSSecret | bool | `false` |  |
| topologyWebhook.pod.resources.requests | object | `{}` |  |
| topologyWebhook.pod.securityContext.allowPrivilegeEscalation | bool | `false` |  |
| topologyWebhook.pod.securityContext.capabilities.drop[0] | string | `"ALL"` |  |
| topologyWebhook.pod.securityContext.privileged | bool | `false` |  |
| topologyWebhook.pod.securityContext.readOnlyRootFilesystem | bool | `true` |  |
| topologyWebhook.pod.securityContext.runAsGroup | int | `65534` |  |
| topologyWebhook.pod.securityContext.runAsNonRoot | bool | `true` |  |
| topologyWebhook.pod.securityContext.runAsUser | int | `65534` |  |
| topologyWebhook.pod.securityContext.seccompProfile.type | string | `"RuntimeDefault"` |  |
| topologyWebhook.service.annotations | object | `{}` |  |
| topologyWebhook.tls | object | `{}` |  |
