...
[httproute]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.5/spec/#httproute
[httprouterule]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.5/spec/#httprouterule
[hostname]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.5/spec/#hostname
[rfc-3986]: https://tools.ietf.org/html/rfc3986
[matches]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.5/spec/#httproutematch
[filters]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.5/spec/#httproutefilter
[backendRef]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.5/spec/#httpbackendref
[parentRef]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.5/spec/#parentreference
[timeouts]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.5/spec/#httproutetimeouts
[appProtocol]: https://kubernetes.io/docs/concepts/services-networking/service/#application-protocol
[sectionName]: https://gateway-api.sigs.k8s.io/reference/api-spec/1.5/spec/#sectionname
