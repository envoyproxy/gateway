...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *APIKeyAuthHeaderForwarding) DeepCopyInto(out *APIKeyAuthHeaderForwarding) {
	*out = *in
	if in.ClientIdentityHeader != nil {
		in, out := &in.ClientIdentityHeader, &out.ClientIdentityHeader
		*out = new(string)
		**out = **in
	}
	if in.SuppressCredentials != nil {
		in, out := &in.SuppressCredentials, &out.SuppressCredentials
		*out = new(bool)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new APIKeyAuthHeaderForwarding.
func (in *APIKeyAuthHeaderForwarding) DeepCopy() *APIKeyAuthHeaderForwarding {
	if in == nil {
		return nil
	}
	out := new(APIKeyAuthHeaderForwarding)
	in.DeepCopyInto(out)
	return out
}
