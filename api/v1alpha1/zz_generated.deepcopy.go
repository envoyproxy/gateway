...
func (in *CustomResponseMatch) DeepCopyInto(out *CustomResponseMatch) {
	*out = *in
	...
	if in.Headers != nil {
		in, out := &in.Headers, &out.Headers
		*out = make([]ResponseHeaderMatch, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResponseHeaderMatch) DeepCopyInto(out *ResponseHeaderMatch) {
	*out = *in
	if in.Type != nil {
		in, out := &in.Type, &out.Type
		*out = new(ResponseHeaderMatchType)
		**out = **in
	}
	if in.Value != nil {
		in, out := &in.Value, &out.Value
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResponseHeaderMatch.
func (in *ResponseHeaderMatch) DeepCopy() *ResponseHeaderMatch {
	if in == nil {
		return nil
	}
	out := new(ResponseHeaderMatch)
	in.DeepCopyInto(out)
	return out
}
