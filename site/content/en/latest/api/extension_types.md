...
| `mergeBackends` | _boolean_ |  false  |  | MergeBackends enables backend-targeted BackendTrafficPolicy and cluster<br />deduplication for routes sharing the same backend. |
