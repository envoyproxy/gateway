...
func processXdsCluster(tCtx *types.ResourceVersionTable, name string, route clusterArgs, extras *ExtraArgs) error {
	return addXdsCluster(tCtx, route.asClusterArgs(name, extras))
}
