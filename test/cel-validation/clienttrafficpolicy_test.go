...
func TestClientTrafficPolicyTarget(t *testing.T) {
	...
	cases := []struct {
		...
		{
			desc: "setting valid TLS resumption",
			mutate: func(ctp *egv1a1.ClientTrafficPolicy) {
				ctp.Spec = egv1a1.ClientTrafficPolicySpec{
					PolicyTargetReferences: egv1a1.PolicyTargetReferences{
						TargetRef: &gwapiv1a2.LocalPolicyTargetReferenceWithSectionName{
					...
					TLS: &egv1a1.ClientTLSSettings{
						SessionResumptionSettings: []egv1a1.SessionResumptionSettings{
							{
								Type: egv1a1.StatefulTLSSessionResumption,
							},
							{
								Type: egv1a1.StatelessTLSSessionResumption,
							},
						},
					},
				}
		...
		{
			desc: "setting invalid TLS resumption: more than 2",
			mutate: func(ctp *egv1a1.ClientTrafficPolicy) {
				ctp.Spec = egv1a1.ClientTrafficPolicySpec{
					PolicyTargetReferences: egv1a1.PolicyTargetReferences{
						TargetRef: &gwapiv1a2.LocalPolicyTargetReferenceWithSectionName{
			...
			wantErrors: []string{"spec.tls.sessionResumption: Too many: 4: must have at most 2 items"},
		},
		{
			desc: "setting invalid TLS resumption: repeated StatefulTLSSessionResumption",
			mutate: func(ctp *egv1a1.ClientTrafficPolicy) {
				ctp.Spec = egv1a1.ClientTrafficPolicySpec{
					PolicyTargetReferences: egv1a1.PolicyTargetReferences{
						TargetRef: &gwapiv1a2.LocalPolicyTargetReferenceWithSectionName{
			...
			wantErrors: []string{"spec.tls.sessionResumption: Invalid value: \"array\": Stateful resumption cannot be repeated"},
		},
		{
			desc: "setting invalid TLS resumption: repeated StatelessTLSSessionResumption",
			mutate: func(ctp *egv1a1.ClientTrafficPolicy) {
				ctp.Spec = egv1a1.ClientTrafficPolicySpec{
					PolicyTargetReferences: egv1a1.PolicyTargetReferences{
						TargetRef: &gwapiv1a2.LocalPolicyTargetReferenceWithSectionName{
			...
			wantErrors: []string{"spec.tls.sessionResumption: Invalid value: \"array\": Stateless resumption cannot be repeated"},
		},
		{
			desc: "setting invalid TLS resumption: unsupported",
			mutate: func(ctp *egv1a1.ClientTrafficPolicy) {
				ctp.Spec = egv1a1.ClientTrafficPolicySpec{
					PolicyTargetReferences: egv1a1.PolicyTargetReferences{
						TargetRef: &gwapiv1a2.LocalPolicyTargetReferenceWithSectionName{
			...
			wantErrors: []string{"spec.tls.sessionResumption[0].type: Unsupported value: \"foo\": supported values: \"Stateful\", \"Stateless\""},
		},
		{
			desc: "valid timeout",
			mutate: func(ctp *egv1a1.ClientTrafficPolicy) {
