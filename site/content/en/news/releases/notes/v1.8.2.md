...
## Security updates
- Bumped the Envoy Proxy image to v1.38.3, which includes several CVE fixes. Read https://www.envoyproxy.io/docs/envoy/v1.38.3/version_history/v1.38/v1.38.3 for additional details.
...
- Fixed a panic when the EnvoyGateway Kubernetes provider sets a `deploy` block without specifying a `type`.
