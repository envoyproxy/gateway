...
func (in *ClientTLSSettings) DeepCopyInto(out *ClientTLSSettings) {
	*out = *in
	...
	if in.SessionResumptionSettings != nil {
		in, out := &in.SessionResumptionSettings, &out.SessionResumptionSettings
		*out = make([]SessionResumptionSettings, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SessionResumptionSettings) DeepCopyInto(out *SessionResumptionSettings) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SessionResumptionSettings.
func (in *SessionResumptionSettings) DeepCopy() *SessionResumptionSettings {
	if in == nil {
		return nil
	}
	out := new(SessionResumptionSettings)
	in.DeepCopyInto(out)
	return out
}
