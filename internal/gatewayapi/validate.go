...
// markProtocolConflicts iterates portListenerInfo and marks any listeners whose protocol
// is incompatible with the first non-UDP listener on the same port.
