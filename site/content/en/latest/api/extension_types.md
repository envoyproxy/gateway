...
| `extensionApis` | _[ExtensionAPISettings](#extensionapisettings)_ |  false  |  | Deprecated: use ExtensionAPI instead.<br />ExtensionAPIs defines the settings related to specific Gateway API Extensions<br />implemented by Envoy Gateway |
| `extensionAPI` | _[ExtensionAPISettings](#extensionapisettings)_ |  false  |  | ExtensionAPI defines the settings related to specific Gateway API Extensions<br />implemented by Envoy Gateway |
