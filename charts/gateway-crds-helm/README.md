...
``` shell
    helm install gateway-crds oci://docker.io/envoyproxy/gateway-crds-helm --version v0.0.0-latest -n monitoring --create-namespace
```
...
``` shell
    helm uninstall gateway-crds -n monitoring
```
...
|-----|------|---------|-------------|
| crd.apiGateway.enabled | bool | `false` |  |
| crd.envoyGateway.enabled | bool | `true` |  |
