...
func (in *EnvoyProxySpec) DeepCopyInto(out *EnvoyProxySpec) {
	*out = *in
	...
	if in.ExtensionPolicySettings != nil {
		in, out := &in.ExtensionPolicySettings, &out.ExtensionPolicySettings
		*out = new(ExtensionPolicySettings)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExtensionPolicySettings) DeepCopyInto(out *ExtensionPolicySettings) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExtensionPolicySettings.
func (in *ExtensionPolicySettings) DeepCopy() *ExtensionPolicySettings {
	if in == nil {
		return nil
	}
	out := new(ExtensionPolicySettings)
