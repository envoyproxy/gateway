...
func init() {
	ConformanceTests = append(ConformanceTests,
		...
		ConsistentHashQueryParamLoadBalancingTest,
	)
}
...
var ConsistentHashQueryParamLoadBalancingTest = suite.ConformanceTest{
	ShortName:   "QueryParamBasedConsistentHashLoadBalancing",
