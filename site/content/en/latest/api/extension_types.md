...
| `issuerRef` | _[SecretObjectReference](https://gateway-api.sigs.k8s.io/reference/1.4/spec/#secretobjectreference)_ |  false  |  | IssuerRef defines the OIDC Provider's configuration as a reference to a secret or configmap.<br />The referenced resource should contain the following keys:<br />- issuer<br />- authorization-endpoint<br />- token-endpoint<br />- end-session-endpoint<br />Only one of issuer or issuerRef must be set. |
