...
type BackendTLSConfig struct {
	...
	// that references it. If namespace is omitted, the referencing resource's namespace
	// is used. If specified, namespace must match the referencing resource's namespace.
