...
func NewManager(ctx context.Context, cfg *config.Server, logger logging.Logger, errors message.ErrorNotifier) (mgr Manager, err error) {
...
func newManagerForKubernetes(cfg *config.Server, errors message.ErrorNotifier) (Manager, error) {
...
func newManagerForCustom(ctx context.Context, cfg *config.Server, logger logging.Logger, errors message.ErrorNotifier) (Manager, error) {
