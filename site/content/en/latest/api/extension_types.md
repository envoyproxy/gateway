...
| `enableRoutePriority` | _boolean_ |  false  |  | EnableRoutePriority determines whether the gateway.envoyproxy.io/route-priority<br />annotation is used to order HTTPRoute and GRPCRoute matches. Higher values<br />take precedence. When unset or false, the annotation is ignored.<br />Default: False |
