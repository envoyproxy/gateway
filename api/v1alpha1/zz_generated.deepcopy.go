...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ForceLocal) DeepCopyInto(out *ForceLocal) {
	*out = *in
	if in.MinEndpointsInZoneCount != nil {
		in, out := &in.MinEndpointsInZoneCount, &out.MinEndpointsInZoneCount
		*out = new(uint32)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ForceLocal.
func (in *ForceLocal) DeepCopy() *ForceLocal {
	if in == nil {
		return nil
	}
	out := new(ForceLocal)
...
func (in *ZoneAware) DeepCopyInto(out *ZoneAware) {
	*out = *in
	...
	if in.MinEndpointsCount != nil {
		in, out := &in.MinEndpointsCount, &out.MinEndpointsCount
		*out = new(uint64)
		**out = **in
	}
}
